...
- You MUST save your latest, complete Python model solution to `/workspace/solution.py` every time you write or update it. This file will be read by the system.
- Function signatures:
  - def init_state():
